...
class Authentication {
        ...
        <div class="auth-form">
          ...
          <form id="login-form" class="form active">
            ...
            <div class="form-group">
              <label for="login-id">ID Number (13 digits)</label>
              <input type="text" id="login-id" maxlength="13" pattern="[0-9]{13}" required>
            </div>
            <div class="form-group">
  ...
  async handleLogin(e) {
    e.preventDefault();
    const idNumber = document.getElementById('login-id').value;
